          ...
          >
            <div class="flex-none sm:flex">
              ...
              <div class="flex-auto sm:ml-5 justify-evenly">
                <div class="flex items-center justify-between sm:mt-2">
                  <div class="flex items-center">
                    <div class="div_area flex flex-col">
                      ...
                      <div class="flex-auto text-primary-100 my-1">
                ...
                <div class="flex pt-2 text-sm text-primary-100">
        ...
        <div class="grid grid-cols-12 gap-4">
          <div class="col-span-12 sm:col-span-4">
            ...
            >
              ...
              <div class="text-sm text-primary-200">Components</div>
            </div>
          </div>
          <div class="col-span-12 sm:col-span-4">
            <div
            ...
            >
              ...
              <div class="flex justify-between items-center">
                <i class="fab fa-behance text-xl text-primary-100"></i>
              </div>
              <div class="text-2xl text-gray-100 font-medium leading-8 mt-5">
                99
              </div>
              <div class="text-sm text-primary-200">Projects</div>
            </div>
          </div>
          <div class="col-span-12 sm:col-span-4">
            <div
            ...
            >
              ...
              <div class="flex justify-between items-center">
                <i class="fab fa-codepen text-xl text-primary-100"></i>
              </div>
              <div class="text-2xl text-gray-100 font-medium leading-8 mt-5">
                50
              </div>
              <div class="text-sm text-primary-200">Pen Items</div>
            </div>
          </div>
        </div>
        <div class="grid gap-4 grid-cols-1 md:grid-cols-2">
          ...
          >
            <div class="">
              <div class="text-center p-5 flex-auto justify-center">
                ...
                <p class="text-sm text-primary-200 px-8">
              ...
              <div class="flex items-center justify-between">
                <div class="flex items-center mr-auto">
                  ...
                  <div class="flex flex-col ml-3">
                    ...
                    <p class="text-sm text-primary-200 leading-none mt-1">
                      UI/UX Designer
                    </p>
                  </div>
                </div>
                <a
                  href="#"
                  class="flex-no-shrink text-xs font-medium tracking-wider text-primary-100 hover:text-green-400 transition ease-in duration-300 mr-2"
                  ><svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="h-5 w-5"
                    viewBox="0 0 20 20"
                ...
                <a
                  hrf="#"
                  class="flex-no-shrink text-xs font-medium tracking-wider text-primary-100 hover:text-green-400 transition ease-in duration-300 ml-2"
                  ><svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="h-5 w-5"
                    viewBox="0 0 20 20"
              ...
              <div class="flex items-center justify-between">
                <div class="flex items-center mr-auto">
                  ...
                  <div class="flex flex-col ml-3 min-w-0">
                    ...
                    <p
                      class="text-sm text-primary-200 leading-none mt-1 truncate"
                    >
                ...
                <div class="flex flex-col ml-3 min-w-0">
                  <span class="text-xs text-primary-200 text-right mb-1"
                    >9:02pm</span
                  >
                  <div class="flex">
                    <a
                ...
                <div class="flex items-center mr-auto">
                  <div class="-space-x-5 flex">
                    <img
                      src="https://tailwindcomponents.com/storage/avatars/njkIbPhyZCftc4g9XbMWwVsa7aGVPajYLRXhEeoo.jpg"
                      alt="aji"
                      class="relative p-1 w-12 h-12 object-cover rounded-2xl border-2 border-gray-600 bg-primary-500"
                    />
                    <img
                      src="https://tailwindcomponents.com/storage/avatars/njkIbPhyZCftc4g9XbMWwVsa7aGVPajYLRXhEeoo.jpg"
                      alt="aji"
                      class="relative p-1 w-12 h-12 object-cover rounded-2xl border-2 border-gray-600 bg-primary-500 shadow"
                    />
                  </div>
          ...
          >
            <div class="flex items-center justify-between">
              ...
              <a
                class="flex-no-shrink text-xs font-medium tracking-wider text-primary-100 hover:text-green-400 transition ease-in duration-300"
                ><svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="h-5 w-5"
                  viewBox="0 0 20 20"
            ...
            <div class="flex">
              ...
              <div class="flex flex-col justify-center w-full px-2 py-1">
                <div class="flex justify-between items-center">
                  ...
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="h-5 w-5 text-primary-100 hover:text-green-400 cursor-pointer"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
                ...
                <div class="flex pt-2 text-sm text-primary-200">
                  <div class="flex items-center mr-auto">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
              ...
              <div class="flex-auto lg:ml-3 justify-evenly py-2">
                <div class="flex flex-col">
                  <div class="flex items-center mr-auto text-sm">
                    ...
                    <p class="font-normal text-primary-200">4.5</p>
                  </div>
                  <div class="flex items-center justify-between min-w-0">
                    ...
                    <div class="flex items-center font-medium text-gray-300">
                      ...
                      800
                      <span class="text-primary-200 text-sm font-normal">
                        /Day</span
                      >
                    </div>
                  </div>
                  <p class="flex items-center text-sm text-primary-100">
                ...
                <div class="flex space-x-3 text-sm font-medium">
                  <div
                    class="flex-auto items-center flex space-x-3 text-xs text-primary-200"
                  >
